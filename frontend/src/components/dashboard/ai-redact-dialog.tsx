  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start sm:items-center justify-start sm:justify-center gap-1 sm:gap-2">
        ...
        <p className="text-xs sm:text-sm sm:text-center font-[500]">
          {description}
        </p>
      </div>
    </div>
...
export default function AIRedactDialog({
  trigger,
    ...
    <>
      ...
      <Dialog open={redactDialogOpen} onOpenChange={setRedactDialogOpen}>
        ...
        <DialogContent className={cn("max-w-screen-lg")}>
          <DialogHeader>
            <DialogTitle className={cn("text-center text-3xl font-[500]")}>
              What type of File{" "}
              <span className="text-primary">would you like to Redact?</span>
            </DialogTitle>
          </DialogHeader>
